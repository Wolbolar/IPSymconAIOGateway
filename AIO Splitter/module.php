...
class AIOSplitter extends IPSModule
{
    ...
    public function Create()
    {
        ...
        $this->SetReceiveDataFilter(".*type.*");
    }
...
// Eigene Variablen
    ...
    public function ReceiveData($JSONString)
    {
        ...
        $this->SendDataToChildren(json_encode(['DataID' => '{C8D0BA3C-CB15-A3B6-A032-C7631E324E87}', 'Buffer' => $data->Buffer])); //AIOSplitter Interface GUI
    }
