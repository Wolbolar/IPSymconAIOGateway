...
dem [Recherche Tool von Mediola.](http://www.mediola.com/recherche-tool-gesamt) nachgeschaut werden. Insofern das AIO Gateway das Gerät unterstützt kann dann auch eine Ansteuerung über IP-Symcon erfolgen.
